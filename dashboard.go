...
// GetDashboardContent return the content of index page.
func GetDashboardContent(ctx *context.Context) (types.Panel, error) {
	...
	smallbox1 := smallbox.New().SetColor("blue").SetIcon("ion-ios-gear-outline").SetUrl("/").SetTitle("new users").SetValue("99999￥").GetContent()
